#!/bin/bash
# Dev environment 4 - Backend (8003) + Frontend (3003)
...
echo -e "${BLUE}🚀 Starting StoFlow Dev Environment 4${NC}"
...
# Cleanup function
cleanup() {
    echo -e "\n${YELLOW}🛑 Stopping dev environment 4...${NC}"
    ...
    echo -e "${GREEN}✅ Dev environment 4 stopped${NC}"
    exit 0
}
...
NUXT_PORT=${FRONTEND_PORT} NUXT_PUBLIC_API_URL=http://localhost:${BACKEND_PORT} NUXT_PUBLIC_API_BASE_URL=http://localhost:${BACKEND_PORT}/api NUXT_PUBLIC_DEV_ENV=4 npm run dev > ../logs/${ENV_NAME}-frontend.log 2>&1 &
FRONTEND_PID=$!
cd ..
...
echo ""
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${GREEN}✨ Dev Environment 4 is ready!${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
