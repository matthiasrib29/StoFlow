...
class EtsyDeleteJobHandler(BaseJobHandler):
    """
    ...
    async def execute(self, job: MarketplaceJob) -> dict[str, Any]:
        """
        Delete Etsy listing (deactivate).
        ...
        self.log_start(f"Deleting Etsy listing for product {product_id}")
        ...
        try:
            ...
            if result.get("success", False):
                ...
                self.log_success(
                    ...
                    f"Etsy listing {etsy_listing_id} deactivated"
                )
            else:
