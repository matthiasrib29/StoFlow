...
2. ⚠️ PROTECTION OBLIGATOIRE avant checkout (ajoutée 2026-01-13) :
   ...
   **Si problème détecté** → Afficher :
   ```
   ╔══════════════════════════════════════════════════════════════╗
   ║  ⚠️ PROTECTION: Changements détectés dans ~/StoFlow          ║
   ╠══════════════════════════════════════════════════════════════╣
   ║  [détails des changements/commits]                           ║
   ║                                                              ║
   ║  Options:                                                    ║
   ║  1. Stash/Push les changements d'abord                       ║
   ║  2. Créer une branche de sauvegarde                          ║
   ║  3. Abandonner ces changements (⚠️ PERTE DE DONNÉES)         ║
   ║                                                              ║
